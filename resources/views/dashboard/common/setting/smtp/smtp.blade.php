...
@section('sub-title') @translate(Setup)  @endsection
                ...
                <div class="col-lg-5">
                    <div class="card bg-gray-light">
                        <div class="card-body">
                            ...
                            <p class="text-danger">@translate(Please be carefully when you are configuring SMTP.)
                                @translate(For incorrect configuration you will get error at the time of)
                                @translate(order place, new registration, sending newsletter.)</p>
                            <hr>
