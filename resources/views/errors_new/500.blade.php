    ...
    <div class="error-wrapper error-page1">
        <div class="container">
                        ...
                        <g id="freepik--Www--inject-141">
                            ...
                            <g id="freepik--World--inject-141">
                                ...
                                <path
                                    ...
                                    style="fill:#6362E7"></path>
                                <rect x="177.08" y="155.92" width="2.87" height="89.88" style="fill:#6362E7">
                                </rect>
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <p class="sub-content">@translate(The page you are attempting to reach is currently not available). @translate(This may be because the page does not exist or has been moved).</p><a class="btn btn-primary btn-lg"
                    href="{{ route('home') }}">@translate(BACK TO HOME PAGE)</a>
            </div>
        </div>
    </div>
@endsection
